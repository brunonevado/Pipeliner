...
#ifndef __pGUI__paths__
#define __pGUI__paths__
...
public:
    paths();
    //void set_path_ms ( std::string in ) { path_ms = in; }
    //void set_path_pipeliner ( std::string in ) { path_pipeliner = in; }
