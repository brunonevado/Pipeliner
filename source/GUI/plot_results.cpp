...
plot_results::plot_results()
{
  ...
  plot_fun.push_back("          \"Sensitivity RR\",");
  plot_fun.push_back("          \"Recovery AA\",");
  plot_fun.push_back("          \"Sensitivity AA\",");
  ...
  plot_fun.push_back("          \"Sensitivity RA\",");
  ...
  plot_fun.push_back("        x$\"Sensitivity RR\" <- (invar_screened - invar_wrong )* 100 /  invar_screened");
  plot_fun.push_back("    ");
  ...
  plot_fun.push_back("        x$\"Sensitivity AA\"  <- data$V3[ which( data$V2 == \"aa_aa\" ) ] * 100 /  data$V3[ which( data$V2 == \"aa_see\" ) ]");
  ...
  plot_fun.push_back("        x$\"Sensitivity RA\"  <- data$V3[ which( data$V2 == \"ra_ra\" ) ] * 100 /  data$V3[ which( data$V2 == \"ra_see\" ) ]");
  ...
  plot_fun.push_back("");
  plot_fun.push_back("    ## Sensitivity RR");
  plot_fun.push_back("    maxp = max(mlist[[1]]$\"Sensitivity RR\",na.rm=TRUE)");
  plot_fun.push_back("    minp = min(mlist[[1]]$\"Sensitivity RR\",na.rm=TRUE)");
  plot_fun.push_back("    if( length(mlist) > 1 )");
  plot_fun.push_back("      for(i in 2:length(mlist)){");
  plot_fun.push_back("        maxp = max( c(maxp, mlist[[i]]$\"Sensitivity RR\"),na.rm=TRUE )");
  plot_fun.push_back("        minp = min( c(minp, mlist[[i]]$\"Sensitivity RR\"),na.rm=TRUE )");
  plot_fun.push_back("    }");
  plot_fun.push_back("    minp = minp*0.9");
  plot_fun.push_back("    maxp = maxp*1.1");
  plot_fun.push_back("    minp=max(c(0,minp))");
  plot_fun.push_back("    maxp=min(c(100,maxp))");
  plot_fun.push_back("    boxplot(mlist[[1]]$\"Sensitivity RR\",xlim=c(0.5,length(mlist)+0.5 ),ylim=c(minp,maxp),at=1,names=\"\",labels=\"\")");
  plot_fun.push_back("    if( length(mlist) > 1 )");
  plot_fun.push_back("      for (i in 2:length(mlist))");
  plot_fun.push_back("        boxplot(mlist[[i]]$\"Sensitivity RR\",at=i,add=TRUE)");
  plot_fun.push_back("    axis(1,1:length(mlist),names(mlist),las=2)");
  plot_fun.push_back("    title(main=\"Invariable\npositions\",y=\"Sensitivity (%)\")");
  plot_fun.push_back("");
  plot_fun.push_back("    ## Sensitivity RA");
  plot_fun.push_back("    maxp = max(mlist[[1]]$\"Sensitivity RA\",na.rm=TRUE)");
  plot_fun.push_back("    minp = min(mlist[[1]]$\"Sensitivity RA\",na.rm=TRUE)");
  plot_fun.push_back("    if( length(mlist) > 1 )");
  plot_fun.push_back("      for(i in 2:length(mlist)){");
  plot_fun.push_back("        maxp = max( c(maxp, mlist[[i]]$\"Sensitivity RA\"),na.rm=TRUE )");
  plot_fun.push_back("        minp = min( c(minp, mlist[[i]]$\"Sensitivity RA\"),na.rm=TRUE )");
  plot_fun.push_back("    }");
  plot_fun.push_back("    minp = minp*0.9");
  plot_fun.push_back("    maxp = maxp*1.1");
  plot_fun.push_back("    minp=max(c(0,minp))");
  plot_fun.push_back("    maxp=min(c(100,maxp))");
  plot_fun.push_back("    boxplot(mlist[[1]]$\"Sensitivity RA\",xlim=c(0.5,length(mlist)+0.5 ),ylim=c(minp,maxp),at=1,names=\"\",labels=\"\")");
  plot_fun.push_back("    if( length(mlist) > 1 )");
  plot_fun.push_back("      for (i in 2:length(mlist))");
  plot_fun.push_back("        boxplot(mlist[[i]]$\"Sensitivity RA\",at=i,add=TRUE)");
  plot_fun.push_back("    axis(1,1:length(mlist),names(mlist),las=2)");
  plot_fun.push_back("    title(main=\"Heterozygous\nSNPs\",y=\"Sensitivity (%)\")");
  plot_fun.push_back("");
  plot_fun.push_back("    ## Sensitivity AA");
  plot_fun.push_back("    maxp = max(mlist[[1]]$\"Sensitivity AA\",na.rm=TRUE)");
  plot_fun.push_back("    minp = min(mlist[[1]]$\"Sensitivity AA\",na.rm=TRUE)");
  plot_fun.push_back("    if( length(mlist) > 1 )");
  plot_fun.push_back("      for(i in 2:length(mlist)){");
  plot_fun.push_back("        maxp = max( c(maxp, mlist[[i]]$\"Sensitivity AA\"),na.rm=TRUE )");
  plot_fun.push_back("        minp = min( c(minp, mlist[[i]]$\"Sensitivity AA\"),na.rm=TRUE )");
  plot_fun.push_back("    }");
  plot_fun.push_back("    minp = minp*0.9");
  plot_fun.push_back("    maxp = maxp*1.1");
  plot_fun.push_back("    minp=max(c(0,minp))");
  plot_fun.push_back("    maxp=min(c(100,maxp))");
  plot_fun.push_back("    boxplot(mlist[[1]]$\"Sensitivity AA\",xlim=c(0.5,length(mlist)+0.5 ),ylim=c(minp,maxp),at=1,names=\"\",labels=\"\")");
  plot_fun.push_back("    if( length(mlist) > 1 )");
  plot_fun.push_back("      for (i in 2:length(mlist))");
  plot_fun.push_back("        boxplot(mlist[[i]]$\"Sensitivity AA\",at=i,add=TRUE)");
  plot_fun.push_back("    axis(1,1:length(mlist),names(mlist),las=2)");
  plot_fun.push_back("    title(main=\"Homozygous\nSNPs\",y=\"Sensitivity (%)\")");
  plot_fun.push_back("");
  ...
  plot_fun.push_back("        axis(2,seq(0,min(c(ymax,100)),20),seq(0,min(c(100,ymax)),20))");
  plot_fun.push_back("        title(main=\"Homozygous SNPs\",y=\"Sensitivity per AAC (%)\",x=\"AAC class\" )");
  plot_fun.push_back("        }");
  plot_fun.push_back("    }");
  plot_fun.push_back("");
